...
class TemplateHTMLRenderer(BaseRenderer):
    ...
    be used as context for the templates.

    The templates name is determined by (in order of preference):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        """
        Renders data to HTML, using Django's standard templates rendering.
    ...
    def get_template_names(self, response, view):
        ...
        raise ImproperlyConfigured(
            'Returned a templates response with no `template_name` attribute set on either the view or response'
        )
    ...
    def get_exception_template(self, response):
        ...
        try:
            # Try to find an appropriate error templates
...
class StaticHTMLRenderer(TemplateHTMLRenderer):
    ...
    For templates rendered HTML, see TemplateHTMLRenderer.
    """
    media_type = 'text/html'
    format = 'html'
    charset = 'utf-8'
...
class HTMLFormRenderer(BaseRenderer):
    ...
    def render_field(self, field, parent_style):
        ...
        if 'templates' in style:
            template_name = style['templates']
        else:
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        # (Do this *after* we've rendered the templates so that we include
