...
class IndicesClient(NamespacedClient):
    ...
    def analyze(self, body=None, index=None, params=None, headers=None):
        ...
        text.
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-analyze.html>`_
    ...
    def refresh(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-refresh.html>`_
    ...
    def flush(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-flush.html>`_
    ...
    def create(self, index, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-create-index.html>`_
    ...
    def clone(self, index, target, body=None, params=None, headers=None):
        """
        Clones an index
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-clone-index.html>`_
    ...
    def get(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-get-index.html>`_
    ...
    def open(self, index, params=None, headers=None):
        """
        Opens an index.
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-open-close.html>`_
    ...
    def delete(self, index, params=None, headers=None):
        """
        Deletes an index.
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-delete-index.html>`_
    ...
    def exists(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-exists.html>`_
    ...
    def exists_type(self, index, doc_type, params=None, headers=None):
        ...
        (DEPRECATED)
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-types-exists.html>`_
    ...
    def put_mapping(self, body, index=None, doc_type=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-put-mapping.html>`_
    ...
    def get_mapping(self, index=None, doc_type=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-get-mapping.html>`_
    ...
    def get_field_mapping(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-get-field-mapping.html>`_
    ...
    def put_alias(self, index, name, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-aliases.html>`_
    ...
    def put_template(self, name, body, params=None, headers=None):
        """
        Creates or updates an index templates.
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-templates.html>`_

        :arg name: The name of the templates
        :arg body: The templates definition
        :arg create: Whether the index templates should only be added if
            new or can also replace an existing one
        :arg include_type_name: Whether a type should be returned in the
            body of the mappings.
        :arg master_timeout: Specify timeout for connection to master
        :arg order: The order for this templates when merging multiple
    ...
    def exists_template(self, name, params=None, headers=None):
        """
        Returns information about whether a particular index templates exists.
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-templates.html>`_
    ...
    def get_settings(self, index=None, name=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-get-settings.html>`_
    ...
    def put_settings(self, body, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-update-settings.html>`_
    ...
    def stats(self, index=None, metric=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-stats.html>`_
    ...
    def segments(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-segments.html>`_
    ...
    def validate_query(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/search-validate.html>`_
    ...
    def clear_cache(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-clearcache.html>`_
    ...
    def recovery(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-recovery.html>`_
    ...
    def upgrade(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-upgrade.html>`_
    ...
    def flush_synced(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-synced-flush-api.html>`_
    ...
    def shard_stores(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-shards-stores.html>`_
    ...
    def forcemerge(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-forcemerge.html>`_
    ...
    def shrink(self, index, target, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-shrink-index.html>`_
    ...
    def split(self, index, target, body=None, params=None, headers=None):
        ...
        shards.
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-split-index.html>`_
    ...
    def rollover(self, alias, body=None, new_index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-rollover-index.html>`_
    ...
    def freeze(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/freeze-index-api.html>`_
    ...
    def unfreeze(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/unfreeze-index-api.html>`_
    ...
    def reload_search_analyzers(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-reload-analyzers.html>`_
    ...
    def simulate_index_template(self, name, body=None, params=None, headers=None):
        ...
        :arg name: The name of the index (it must be a concrete index
            name)
        :arg body: New index templates definition, which will be included
            in the simulation, as if it already exists in the system
        :arg cause: User defined reason for dry-run creating the new
            templates for simulation purposes
        :arg create: Whether the index templates we optionally defined in
    ...
    def simulate_template(self, body=None, name=None, params=None, headers=None):
        """
        Simulate resolving the given templates name or body
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/indices-templates.html>`_

        :arg body: New index templates definition to be simulated, if no
            index templates name is specified
        :arg name: The name of the index templates
        :arg cause: User defined reason for dry-run creating the new
            templates for simulation purposes
        :arg create: Whether the index templates we optionally defined in
            the body should only be dry-run added if new or can also replace an
