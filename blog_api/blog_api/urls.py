...
urlpatterns = [
    ...
    path("add_comment/", comments.views.CommentsAddView.as_view(), name="comment add"),
    path("article_add/", articles.views.ArticleAddView.as_view(), name="article add"),
    path(
        "article_detail/<int:article_id>/comments/", articles.views.ArticleDetailView.as_view(), name="article detail"
    ),
    path("articles_search/", articles.views.ArticleSearchView.as_view(), name="search_article"),
